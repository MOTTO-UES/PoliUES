...
$query = "INSERT INTO RESERVA (IDFACULTAD,FECHAINGRESO,NUMEROPERSONAS,MOTIVO,DESCRIPCIONRESERVA)VALUES('".$idfacultad."','".$fechaingreso."','".$numeropersonas."','".$motivo."','".$descripcionreserva."');";
