...
public class AreaMenuActivity extends ListActivity {
    String[] menu={"Insertar Area","Eliminar Area","Consultar Area", "Actualizar Area","Pagina Principal"};
    String[] activities={"AreaInsertarActivity","AreaEliminarActivity","AreaConsultarActivity", "AreaActualizarActivity","principal"};
