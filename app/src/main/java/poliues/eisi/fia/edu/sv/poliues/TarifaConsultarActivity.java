...
public class TarifaConsultarActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(TarifaConsultarActivity.this, TarifaMenuActivity.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
       ...
       // getMenuInflater().inflate(R.menu.tarifa_consultar, menu);
        return true;
    }
    ...
    public void consultarTarifaA(View v) {
        Tarifa tarifa = null;

        System.out.println("CONSULTANDO TARIFA");
        helper.abrir();
        tarifa=helper.consultarTarifa(Integer.valueOf(editCantPersonas.getText().toString()));
        helper.cerrar();
        System.out.println("EJECUTO EL CONSULTAR");
        if(tarifa==null){
            Toast.makeText(this, "Nota no registrada", Toast.LENGTH_LONG).show();
        }else{
            editTarifaUnitaria.setText(String.valueOf(tarifa.getTarifaUnitaria()));
        }
    }
